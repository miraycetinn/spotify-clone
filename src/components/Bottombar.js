...
function Bottombar() {
    return (
        <div className="h-24 bg-footer border-t border-white border-opacity-5 relative flex flex-row">

            <div className="h-14 w-1/3 bg-footer pl-3 pt-3">
                <NowPlayingWidget songName="Swim"
                                  albumCover="https://i.scdn.co/image/ab67616d000048515a0c2870f4f309e382d1fad6"
                                  artist="Chase Atlantic"/>
            </div>

            <div className="flex flex-col w-1/3 justify-evenly h-full items-center ">
                <div className="flex flex-row justify-between">
                    ...
                    <button>
                        <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" fill="#FFFFFF"
                             data-encore-id="icon"
                ...
                <div className="w-full bg-gray-200 rounded-full h-1.5 group dark:bg-gray-700">
                ...
                <div className="flex flex-row ml-48">
                    <button>
                        <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16"
                             data-encore-id="icon" fill="#FFFFFF" className="m-auto Svg-sc-ytk21e-0 uPxdw">
                            <path
                    ...
                    <button>
                        <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16"
                             data-encore-id="icon" fill="#FFFFFF" className="m-auto ml-4 Svg-sc-ytk21e-0 uPxdw">
                            <path
                    ...
                    <button>
                        <svg role="presentation" height="16" width="16" aria-hidden="true"
                             className="m-auto ml-4 Svg-sc-ytk21e-0 uPxdw" fill="#FFFFFF" viewBox="0 0 16 16"
                             data-encore-id="icon">
                            <path
                    ...
                    <button>
                        <svg role="presentation" height="16" width="16" aria-hidden="true" aria-label="Volume high"
                             fill="#FFFFFF" id="volume-icon" viewBox="0 0 16 16" data-encore-id="icon"
                    ...
                    <div className="w-24 m-auto ml-2 bg-gray-200 rounded-full h-1 group dark:bg-gray-700">
                        <div className="bg-white h-1 group-hover:bg-green-600 rounded-full"
                             style={{width: "45%"}}></div>
                    </div>
                    <button>
                        <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16"
                             data-encore-id="icon" fill="#FFFFFF"
                             className="m-auto ml-4 Svg-sc-ytk21e-0 uPxdw">
                            <path
